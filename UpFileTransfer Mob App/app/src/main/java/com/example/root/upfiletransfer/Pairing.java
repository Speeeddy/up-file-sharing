...
public class Pairing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvPairing = (EditText) findViewById(R.id.tvPairing) ;
        ...
        card3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final String user = tvPairing.getText().toString() ;

                final JSONObject jsonObject = new JSONObject() ;
                try {
                    jsonObject.put("username" , tvPairing.getText().toString()) ;
                    ...
                    new AsyncTask<Void , Void , String>(){
                        ...
                        protected void onPostExecute(String s) {
                            ...
                            if(s.trim().toString().equals("\"Userexists\"")){
                                ...
                                try{
                                    jsonObject1.put("sender" , tvPairing.getText().toString()) ;
                                    ...
                                    new AsyncTask<Void , Void , String>(){
                                        ...
                                        protected void onPostExecute(String s) {
                                            ...
                                            Intent i = new Intent(Pairing.this , SendReceive.class) ;
...
//            ret = client.execute(post , handler);
    ...
    private String getServerResponse1(String json){
        HttpPost post  = new HttpPost("https://up-karoon.ga/api/pm/startPairing");
        String ret = "UNABLE TO CONTACT SERVER" ;
        HttpResponse httpResponse ;
        try {
            StringEntity entity = new StringEntity(json);
